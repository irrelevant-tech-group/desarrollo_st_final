...
def get_franquicia_by_phone(phone_number):
    ...
    #credentials_path = service_account_info = json.loads(os.getenv("GOOGLE_CREDENTIALS"))
...
def mass_upload():
    ...
    try:
        ...
        for single_url in urls:
            ...
            analyzer = VehicleMarketplaceAnalyzer(os.getenv("ANTHROPIC_API_KEY")) if is_facebook else MeliVehicleAnalyzer(os.getenv("ANTHROPIC_API_KEY"))
...
if __name__ == '__main__':
    ...
    creds_path = service_account_info = json.loads(os.getenv("GOOGLE_CREDENTIALS"))
